...
sports_final_data.to_csv(f'results/sport_websites_keywords.csv', index=False)
...
tv_streams_final_data.to_csv(f'results/tv_streams_keywords.csv', index=False)
...
file_sharing_hosting_final_data.to_csv(f'results/file_sharing_hosting_keywords.csv', index=False)
